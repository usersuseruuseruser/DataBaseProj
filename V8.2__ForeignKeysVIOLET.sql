...
alter table productsreviews add constraint productsreviews_product_id_fk foreign key(product_id) references category(product_id);
...
alter table purchases add constraint purchases_user_id_fk foreign key(user_id) references products(user_id);
...
alter table order_undergone_refunds add constraint order_undergone_refunds_refund_id_fk foreign key(refund_id) references product_refund(refund_id);
