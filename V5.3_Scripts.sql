...
ALTER TABLE employee_work_in_pickpoint_seq ADD PRIMARY KEY (employee_pickpoint_id);
ALTER TABLE employee_work_in_pickpoint_seq ALTER COLUMN employee_pickpoint_id SET DEFAULT nextval('employee_work_in_pickpoint_seq');