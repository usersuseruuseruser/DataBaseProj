...
ADD CONSTRAINT chk_delivery_id CHECK (delivery_id BETWEEN 0 AND 10_000_000),
ADD CONSTRAINT chk_courier_id CHECK (courier_id BETWEEN 0 AND 1_000_000);

ALTER TABLE employee_work_in_pickpoint 
ADD CONSTRAINT chk_employee_status CHECK (LENGTH(employee_status) > 4),
ADD CONSTRAINT chk_employee_pickpoint_id CHECK (employee_pickpoint_id BETWEEN 0 AND 1_000_000);